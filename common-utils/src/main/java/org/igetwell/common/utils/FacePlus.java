...
public class FacePlus {
    ...
    private static Logger logger = LoggerFactory.getLogger(FacePlus.class);
    ...
    public static JSON getBeautify(String base64Image, String whitening, String smoothing){
        ...
        try{
            ...
            String str = HttpClientUtil.getInstance().sendHttpPost(BEAUTIFY_URL, params, "UTF-8");
